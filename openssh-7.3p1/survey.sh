...
CPPFLAGS="-I/usr/include -I/usr/include -D_OPENBSD_SOURCE -I/usr/include -I/usr/pkg/include -I/usr/pkg/include"
LDFLAGS="-L/usr/lib -L/usr/lib -L/usr/lib -Wl,-R/usr/lib -L/usr/pkg/lib -Wl,-R/usr/pkg/lib -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -fstack-protector-strong -L/usr/pkg/lib"
